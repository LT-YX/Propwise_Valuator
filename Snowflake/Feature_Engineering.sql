...
-- HDB RESALE PRICE Lv
ALTER TABLE FINAL_DATA.HDB_RESALE_PRICES ADD COLUMN SALE_QUARTER STRING;
UPDATE FINAL_DATA.HDB_RESALE_PRICES 
SET SALE_QUARTER = 'Q' || CEIL(SALE_MONTH / 3);
...
UPDATE FINAL_DATA.HDB_PROPERTY_INFO_ENRICHED
SET ADDRESS = BLK_NO || ' ' || STREET ;

-- Drop HDB_Enrichment Table
DROP TABLE RAW_DATA.HDB_Enrichment;

SELECT * FROM FINAL_DATA.HDB_PROPERTY_INFO_ENRICHED limit 5;
